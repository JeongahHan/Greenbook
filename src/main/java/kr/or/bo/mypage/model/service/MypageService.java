...
public class MypageService {
	...
	public MypageListData selectConsumer(Product p, Member m, int reqPage) {
		...
		if (pageNo != 1) {// 페이지 번호가 1이 아닌경우만 1이면 그 전이 없으니까
			pageNavi += "<li>";
			pageNavi += "<a class='page-item' href='/mypage/showConsumer?reqPage=" + (pageNo - 1) + "'>";///페이지나비수정
			pageNavi += "<span class='material-icons'>chevron_left</span>";
			pageNavi += "</a>";
			pageNavi += "</li>";
		}
		...
		for (int i = 0; i < pageNaviSize; i++) {
			if (pageNo == reqPage) {
				pageNavi += "<li>";
				pageNavi += "<a class='page-item active-page' href='/mypage/showConsumer?reqPage=" + (pageNo) + "'>";///페이지나비수정
				pageNavi += pageNo;
				pageNavi += "</a>";
				pageNavi += "</li>";
			} else {
				pageNavi += "<li>";
				pageNavi += "<a class='page-item' href='/mypage/showConsumer?reqPage=" + (pageNo) + "'>";///페이지나비수정
				pageNavi += pageNo;
				pageNavi += "</a>";
				pageNavi += "</li>";
			}
		...
		if (pageNo <= totalPage) {
			pageNavi += "<li>";
			pageNavi += "<a class='page-item' href='/mypage/showConsumer?reqPage=" + (pageNo) + "'>";/// pageNo-1에서 바꿈 ///페이지나비수정
			pageNavi += "<span class='material-icons'>chevron_right</span>"; /// left를 right로
			pageNavi += "</a>";
			pageNavi += "</li>";
		}
